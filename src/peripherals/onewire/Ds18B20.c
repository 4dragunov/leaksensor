...
void DS18B20_init(Ds18B20_t *ds18B20, Uart_t *uart, uint8_t precision)
{   
    uint8_t i=0;
    //fill with zeros
...
uint8_t DS18B20_isTempReady(Ds18B20_t *ds18B20, uint8_t sensor)
{
    ...
    return ((osKernelSysTick() - ds18B20->lastTimeMeasured[sensor])>=ds18B20->timeNeeded);
}

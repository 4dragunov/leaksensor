...
public:
    ...
    /** Constructor. */
    BatteryGaugeBq35100(I2C *pI2c, PinNames gaugeEnable = NC, uint8_t address = BATTERY_GAUGE_BQ35100_ADDRESS,
     ...
     */
    bool init(I2C *pI2c, PinNames gaugeEnable = NC, uint8_t address = BATTERY_GAUGE_BQ35100_ADDRESS,
    		uint32_t sealCodes = SEAL_CODES_DEFAULT);
    ...
    */
     ...
     * @return true if successful, otherwise false.
     */
    bool advancedGetConfig(int32_t address, uint8_t * pData, int32_t length);
     ...
     * @return true if successful, otherwise false.
     */
    bool advancedSetConfig(int32_t address, const uint8_t * pData, int32_t length);
...
protected:
     ...
     */
    uint8_t computeChecksum(const uint8_t * pData, int32_t length);
     ...
     * @return true if successful, otherwise false.
     */
    bool readExtendedData(int32_t address, uint8_t * pData, int32_t length);
     ...
     * @return true if successful, otherwise false.
     */
    bool writeExtendedData(int32_t address, const uint8_t * pData, int32_t length);

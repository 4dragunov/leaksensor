...
const uint8_t NvStore::registry[NV_LAST_VAR] = {
		...
		[MODBUS_SPEED] =  sizeof(uint32_t)/sizeof(Eeprom::data),     // 1
		...
		[LORA_TX_DUTYCYCLE] = sizeof(uint32_t)/sizeof(Eeprom::data), // 9
		[LORA_TX_DUTYCYCLE_RND] = sizeof(uint16_t)/sizeof(Eeprom::data), //11
